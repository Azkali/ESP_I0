...
static const char *TAG = "SDCARD_FLAC_EXAMPLE";

void app_main(void)
{
    audio_pipeline_handle_t pipeline;
    audio_element_handle_t fatfs_stream_reader, i2s_stream_writer, flac_decoder;
   ...
   //     .card_detect_pin = SD_CARD_INTR_GPIO, //GPIO_NUM_34
    ...
    audio_pipeline_link(pipeline, (const char *[]) {"file", "flac", "i2s"}, 3);

    ESP_LOGI(TAG, "[3.6] Setup uri (file as fatfs_stream, flac as flac decoder, and default output is i2s)");
